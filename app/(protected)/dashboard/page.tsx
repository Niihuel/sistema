      ...
      <AnimatedContainer className="text-white p-4 sm:p-6">
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            ...
            <div className="text-white/60">Por favor, inicia sesión primero.</div>
            <a href="/login" className="mt-4 inline-block px-4 py-2 bg-white/10 hover:bg-white/20 rounded-lg">
              Ir al login
            </a>
          </div>
        </div>
